...
public class Recepti extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recepti);

        //zadavame imenata na receptite v list view
        final ListView listView = (ListView) findViewById(R.id.list_recepti);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent appInfo = new Intent(Recepti.this, InfoRecepti.class);
